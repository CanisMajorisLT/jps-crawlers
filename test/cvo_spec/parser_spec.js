...
describe("Cvb parser", () => {
    ...
    describe("extractFrontInfo", () => {
        it("returns an array of extracted data", () => {
            ...
            expect(result).to.be.an('array').with.length(51);
    ...
    describe("extractFrontInfoForOneAd", () => {
        ...
        it("extracts city, title, ad uri, company, and unique id", () => {
            let result = parser.extractFrontInfoForOneAd(frontJobArticle);

            expect(result).to.be.an('object')
                .with.all.keys('uri', 'title', 'city', 'company', 'id', 'views', 'expiryDate');
