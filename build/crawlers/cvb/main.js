        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        handleTaskFail = (0, _main.handleTaskFailureFactory)('CVB');
                        handleTaskSuccess = (0, _main.handleTaskSuccessFactory)('CVB', taskSuccessHandler);
                        ...
                        _context.next = 9;
                        return (0, _main.getNumberOfFrontPages)(FRONT_PAGE_URI.replace('${page}', '1'), _parser.extractTotalPageCount);
